 ...
 * 
 */
package com.taurel.services.weblogin.exception;
...
public class ManejadorExcepciones {
	...
	public static DgFarmException manejar(final String aplicacion,
		...
		if (e instanceof DgFarmException) {
			...
			return (new NotHandledException(aplicacion, origen, -1,
					e.getMessage(), transaccion, plataforma, paramEntrada, e));
		} else {
			return (new NotHandledException(aplicacion, origen, -1,
					GENERIC_ERROR_MESSAGE, transaccion, plataforma,
					paramEntrada, null));
		}
	}
	 ...
	 * @return excepci�n de tipo <code>SegurosCaracasException</code>
	 */
	private static DgFarmException manejarRemoteException(
		...
		if ((e.detail != null)
			...
			return (new PlataformaNoDisponibleException(aplicacion, origen, -1,
					e.getMessage(), transaccion, plataforma, paramEntrada, e));
		} else {
			return (new NotHandledException(aplicacion, origen, -1,
					e.getMessage(), transaccion, plataforma, paramEntrada, e));
	...
	private static DgFarmException manejarBusinessException(String aplicacion,
			String origen, String transaccion, String plataforma,
			String paramEntrada, BusinessException e) {
		// TODO Auto-generated method stub
		return null;
	}

	private static DgFarmException manejarSQLException(String aplicacion,
			String origen, String transaccion, String plataforma,
			String paramEntrada, SQLException e) {
		...
		if (codigo == 0) {
			...
			try {
				...
				return (new NotHandledException(aplicacion, origen, -1,
						mensaje, transaccion, plataforma, paramEntrada,
						(Exception) e));
			}
		}
		if (Arrays.binarySearch(
			...
			return (new PlataformaNoDisponibleException(aplicacion, origen,
					codigo, mensaje, transaccion, plataforma, paramEntrada, e));

		} else if (codigo == ManejadorExcepciones.CODIGO_ORA) {
			return (new HandledException(aplicacion, origen, 1, mensaje,
					transaccion, plataforma, paramEntrada, e));
		} else {
			return (new NotHandledException(aplicacion, origen, -1, mensaje,
					transaccion, plataforma, paramEntrada, e));
		}
	}
	 ...
	 * <code>DgFarmException</code>, mas informaci&oacute;n.
	 * </p>
	 * 
	 * @param aplicacion
	 *            <code>String</code> nombre de la aplicaci&oacute;n
	 ...
	 * @return excepci�n de tipo <code>DgFarmException</code>
	 */
