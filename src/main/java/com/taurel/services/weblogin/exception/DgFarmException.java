...
public abstract class DgFarmException extends Exception {
	 ...
	 *            excepci&oacute;n.
	 */
	public DgFarmException(final String aplicacion, final String origen,
			final int codigo, final String mensaje) {
		super(mensaje);
	 ...
	 */
	public DgFarmException(final String aplicacion, final String origen,
			final int codigo, final String mensaje, final Throwable cause) {
		super(mensaje, cause);
		this.aplicacion = aplicacion;
		this.origen = origen;
		this.codigo = codigo;
	 ...
	 */
	public DgFarmException(final String aplicacion, final String origen,
			final int codigo, final String mensaje, final String transaccion,
